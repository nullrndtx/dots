"-----------------------------------------"
" Source: http://github.com/nullrndtx/vim "
"-----------------------------------------"
...
""" Vundle plugin manager {{{
    ...
    """ Github repos, uncomment to disable a plugin {{{
		...
		Plugin 'trapd00r/vim-extendedcolors'
		Plugin 'trapd00r/vim-ansicolors'
...
""" User interface {{{
    """ Syntax highlighting {{{
        ...
        colorscheme shblah    		        " colorscheme from plugin
